...
// Crime Salad — Clean build (no unused state) + Mailchimp embed + Shopify shop
// Paste this over src/App.js
    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100 selection:bg-fuchsia-400/30">
      ...
      <section id="join-the-list" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-20">
        <div className="mx-auto max-w-3xl text-center py-10 md:py-14">
          <h3 className="text-3xl md:text-4xl font-extrabold tracking-[0.12em] uppercase">
            Join the List
          </h3>
          <p className="mt-3 text-zinc-300">
            Sign up for updates on the investigation and bonus content.
          </p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 grid md:grid-cols-4 gap-10 text-sm">
          <div className="md:col-span-2">
            ...
            <p className="mt-3 text-zinc-400 max-w-sm">
              True crime stories told with care. © {new Date().getFullYear()} Weird Salad Media.
            </p>
          </div>
