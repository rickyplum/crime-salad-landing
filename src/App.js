...
// Crime Salad — Landing (CRA + Tailwind)
...
const LINKS = {
  ...
  TIKTOK:
    "https://www.tiktok.com/@crimesaladpodcast?is_from_webapp=1&sender_device=pc",
...
const PLACEHOLDER =
  'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="800" height="600"><rect width="100%" height="100%" fill="%2318181b"/><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" fill="%23a1a1aa" font-family="Arial, Helvetica, sans-serif" font-size="24">Image unavailable</text></svg>';

const CONTACT_EMAIL = "crimesaladpodcast@gmail.com";

// Spotify embed
function SpotifyPlayer({ showId, episodeId }) {
  const src = `https://open.spotify.com/embed/${
    episodeId ? `episode/${episodeId}` : `show/${showId}`
    ...
    return (
      <div className="text-center">
        ...
        <p className="mt-2 text-xs text-zinc-500">
          Add REACT_APP_SHOPIFY_STOREFRONT_TOKEN to enable in-page products.
        </p>
      </div>
    );
  }
    ...
    return (
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
        {Array.from({ length: 8 }).map((_, i) => (
          <div
            key={i}
            className="rounded-2xl border border-white/10 bg-white/5 p-3 animate-pulse h-56"
          />
        ))}
      </div>
    );
          ...
          >
            <div className="aspect-square overflow-hidden">
              <img
                ...
                onError={(e) => {
                  const ph =
                    "https://images.unsplash.com/photo-1520975922284-9d8a5c0fbf38?q=80&w=800&auto=format&fit=crop";
            ...
            <div className="p-3">
              ...
              {price && (
                <div className="text-sm text-zinc-400 mt-1">{price}</div>
              )}
            </div>
          </a>
        );
      ...
      <header className="sticky top-0 z-40 border-b border-white/10 bg-zinc-950/70 backdrop-blur supports-[backdrop-filter]:bg-zinc-950/60">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-20 grid grid-cols-3 items-center">
          ...
          <nav className="hidden md:flex justify-center items-center gap-8 text-sm text-zinc-300">
            <a href="#join-the-list" className="hover:text-white">
              Join the List
            </a>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 md:py-24 grid md:grid-cols-[520px_1fr] gap-12 items-center">
          <div>
            ...
            <h1 className="mt-3 text-4xl sm:text-5xl md:text-6xl font-extrabold leading-[1.1]">
              <span
                className="bg-gradient-to-r from-fuchsia-300 via-violet-200 to-cyan-200 bg-clip-text text-transparent block fade-line mb-1.5 sm:mb-2 last:mb-0"
            ...
            <p className="mt-4 text-lg text-zinc-300 max-w-xl">
              Real cases told with empathy and rigor — hosted by Ashley and
              Ricky.
            </p>
            ...
            <div id="listen" className="mt-7 flex flex-wrap gap-3">
              ...
              >
                <svg viewBox="0 0 24 24" className="h-4 w-4" fill="currentColor">
                  <path d="M16.37 1.43c-.93.06-2.05.64-2.7 1.39-.59.67-1.11 1.78-.91 2.79.98.08 2.01-.53 2.66-1.28.6-.7 1.09-1.83.95-2.9ZM13.95 5.23c-1.52 0-3.18.88-4.14 2.23-1.79 2.55-.47 6.31 1.28 8.38.85 1.03 1.86 2.19 3.18 2.15 1.28-.06 1.77-.7 3.33-.7 1.54 0 2 .7 3.34.68 1.39-.02 2.25-1.04 3.08-2.08.95-1.18 1.35-2.32 1.37-2.38-.03-.01-2.63-1.01-2.66-4.02-.02-2.52 2.06-3.72 2.15-3.78-1.17-1.72-2.98-1.96-3.61-1.99-1.64-.14-3.02.92-3.81.92-.81 0-1.96-.9-3.19-.9Z" />
                </svg>
                Apple Podcasts
              </a>
              <a
              ...
              >
                <svg viewBox="0 0 24 24" className="h-4 w-4" fill="currentColor">
                  <path d="M23.5 7.6a4.8 4.8 0 0 0-3.4-3.4C17.9 3.6 12 3.6 12 3.6s-5.9 0-8.1.6A4.8 4.8 0 0 0 .5 7.6 50.4 50.4 0 0 0 0 12c0 4.4.5 4.4.5 4.4a4.8 4.8 0 0 0 3.4 3.4c2.2.6 8.1.6 8.1.6s5.9 0 8.1-.6a4.8 4.8 0 0 0 3.4-3.4s.5 0 .5-4.4-.5-4.4-.5-4.4ZM9.6 15.2V8.8l6.4 3.2-6.4 3.2Z" />
                </svg>
                YouTube
              </a>
              <a
              ...
              >
                <svg viewBox="0 0 24 24" className="h-4 w-4" fill="currentColor">
                  <path d="M16.5 3.5v3.2a6.5 6.5 0 0 0 3.1 1v3.1a8.2 8.2 0 0 1-3.1-.7v4.1c0 3.2-2.6 5.8-5.8 5.8S4.9 17.4 4.9 14.2c0-3.2 2.6-5.8 5.8-5.8.4 0 .8 0 1.2.1v3.1a2.7 2.7 0 0 0-1.2-.3 2.7 2.7 0 1 0 2.7 2.7V3.5h3.1z" />
                </svg>
                Watch on TikTok
              </a>
              <a
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="mt-3 text-zinc-300 max-w-prose">
              Ashley leads the storytelling; Ricky brings context and candid
              reactions. Together we break down complex cases with empathy and
              clarity — always prioritizing the truth.
            </p>
      ...
      >
        <div className="p-[1px] rounded-3xl bg-gradient-to-br from-fuchsia-400/30 via-indigo-400/20 to-cyan-300/20">
          <div className="rounded-3xl bg-zinc-950/70 p-8 md:p-12 border border-white/10">
            ...
            <p className="mt-2 text-zinc-300 max-w-xl mx-auto text-center">
              No spam. Just new episodes, behind-the-scenes, and ways to support
            ...
            >
              ...
              <div className="sm:col-span-1">
                <button
                  type="submit"
                  name="subscribe"
                  className="rounded-xl bg-white text-zinc-900 px-5 py-3 text-sm font-semibold hover:bg-zinc-200 transition w-full sm:w-auto"
                >
                  Join the List
                </button>
              </div>
              ...
              <div aria-hidden="true" style={{ position: "absolute", left: "-5000px" }}>
                <input
                  type="text"
                  name="b_cc67224c1a30078239b64e0d3_466ab65f6a"
                  tabIndex={-1}
                  defaultValue=""
                />
              </div>
      ...
      <section id="shop" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        ...
        <ShopifyCollection
          ...
          storefrontAccessToken={
            ...
            "899809aa74e2ecbe671f60a376ef7932"
          }
        ...
        <div className="p-[1px] rounded-3xl bg-gradient-to-br from-fuchsia-400/30 via-indigo-400/20 to-cyan-300/20">
          <div className="rounded-3xl bg-zinc-950/70 p-8 md:p-12 text-center border border-white/10">
            ...
            <p className="mt-2 text-zinc-300">
              Questions, case suggestions, or press? We’d love to hear from you.
            </p>
            <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-3">
              <a
                href={"mailto:" + CONTACT_EMAIL}
                className="inline-flex items-center gap-2 rounded-xl bg-white text-zinc-900 px-5 py-3 text-sm font-semibold hover:bg-zinc-200 focus:outline-none focus:ring-2 focus:ring-white/30"
              >
                <svg viewBox="0 0 24 24" className="h-4 w-4" fill="currentColor" aria-hidden="true">
                  <path d="M2 5.5A2.5 2.5 0 0 1 4.5 3h15A2.5 2.5 0 0 1 22 5.5v13a2.5 2.5 0 0 1-2.5 2.5h-15A2.5 2.5 0 0 1 2 18.5v-13Zm2.4-.5 7.6 5.4L19.6 5H4.4Zm15.1 2.2-6.8 4.9a1.5 1.5 0 0 1-1.8 0L4.1 7.2V18.5c0 .28.22.5.5.5h15a.5.5 0 0 0 .5-.5V7.2Z" />
                </svg>
                Email {CONTACT_EMAIL}
              </a>
              <button
                type="button"
                onClick={() =>
                  navigator.clipboard && navigator.clipboard.writeText(CONTACT_EMAIL)
                }
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 grid md:grid-cols-4 gap-10 text-sm">
          <div className="md:col-span-2">
            ...
            <p className="mt-3 text-zinc-400 max-w-sm">
              True crime stories told with care. © {new Date().getFullYear()} Weird Salad
              Media.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-zinc-400">
              <li>
                <a href={LINKS?.APPLE ?? "#"} className="hover:text-white">
                  Apple Podcasts
                </a>
              </li>
              <li>
                <a href={LINKS?.SPOTIFY ?? "#"} className="hover:text-white">
                  Spotify
                </a>
              </li>
              <li>
                <a href={LINKS?.YOUTUBE ?? "#"} className="hover:text-white">
                  YouTube
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-zinc-400">
              ...
              <li>
                <a href={LINKS?.INSTAGRAM ?? "#"} className="hover:text-white">
                  Instagram
                </a>
              </li>
              <li>
                <a href={LINKS?.TIKTOK ?? "#"} className="hover:text-white">
                  TikTok
                </a>
              </li>
              <li>
